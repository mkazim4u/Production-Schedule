...
Partial Public Class View
    ...
    Protected Sub Page_Load(sender As Object, e As EventArgs)
        ...
        Dim strWebServiceURL As String = [String].Format("http://{0}/{1}", DNN.GetPMB(Me).PortalAlias.HTTPAlias, "DesktopModules/HelloWorld3/Service.svc")

        ' Set the path to the .xap file
        SilverlightApplication = [String].Format("{0}{1}", TemplateSourceDirectory, "/ClientBin/HelloWorld5.xap")
