<%@ Control Language="VB" AutoEventWireup="false" CodeFile="PS_UserRoleAssignment.ascx.vb"
    Inherits="PS_UserRoleAssignment" %>
...
//                }
        ...
        function onListBoxDropping(sender, args) {
            ...
            var target = isOverElement(target, "<%= tvUserRole.ClientID %>");
        ...
        function onTreeViewDropping(sender, args) {
            ...
            if (isOverElement(target, "<%= tvUserRole.ClientID %>")) {
                return;
            }
        ...
        function checkDropTargets(target) {
            if (isOverElement(target, "<%= lstUsers.ClientID %>") || isOverElement(target, "<%= tvUserRole.ClientID %>")) {
...
<fieldset id="fsMain" runat="server">
    <legend class="fieldsetLegend" id="fslgndMain">
        <asp:Label ID="lblUserJobMapping" runat="server" Text="Manage Users" />
    </legend>
    ...
    <telerik:RadAjaxPanel ID="rapUserRoleAssignment" RequestQueueSize="5" runat="server"
        OnAjaxRequest="rapUserRoleAssignment_AjaxRequest" Width="100%" EnableOutsideScripts="True"
        HorizontalAlign="NotSet" ScrollBars="None" LoadingPanelID="alpUserJobMapping">
                        ...
                        <tr>
                            ...
                            <td width="20%">
                                <div style="height: 200px; overflow: auto; width: 100%;">
                                    <telerik:RadTreeView runat="server" ID="tvUserRole" EnableDragAndDrop="True" OnClientMouseOver="onTreeViewMouseOver"
                                        OnClientMouseOut="onTreeViewMouseOut" OnClientNodeDragStart="onTreeViewDragStart"
                                        OnClientNodeDropping="onTreeViewDropping" OnNodeDrop="tvUserRole_NodeDrop" OnClientNodeDragging="onTreeViewDragging"
                                        OnContextMenuItemClick="tvUserRole_ContextMenuItemClick">
                                        <ContextMenus>
