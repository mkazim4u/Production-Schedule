<%@ Control Language="VB" AutoEventWireup="false" CodeFile="PS_FulfilmentCost.ascx.vb"
    Inherits="PS_FulfilmentCost" %>
...
<telerik:RadGrid ID="rgQuotation" runat="server" Width="95%" ShowStatusBar="true"
    ...
    <MasterTableView Width="100%" DataKeyNames="ID" AllowMultiColumnSorting="True" CommandItemDisplay="Top"
        ...
        <Columns>
            ...
            <telerik:GridBoundColumn SortExpression="TariffName" HeaderText="Fulfilment Cost"
        ...
        <EditFormSettings EditFormType="Template" InsertCaption="New Fulfilment Cost">
            <FormTemplate>
                <div>
                ...
                <DetailTables>
                    <telerik:GridTableView DataKeyNames="ID" Width="100%" Name="Items" CommandItemDisplay="Top"
                        ...
                        <Columns>
                            ...
                            <telerik:GridTemplateColumn HeaderText="Per" UniqueName="CostPrice">
                                <ItemTemplate>
        ...
        <CommandItemSettings AddNewRecordText="Add new Fulfilment Cost" AddNewRecordImageUrl="~/Portals/0/Images/AddRecord.gif"
